...
const Collapsible = (props: { id: string, color: string, hook: string, title: string, textPath: string }) => {
    ...
    function collapsible(id: string) {
        ...
        if (collapsible) {
            ...
            if (content) {
                ...
                console.error(`cannot get nextElementSibling for collapsible with id ${id}`)
            }

        } else {
            console.error(`cannot find collapsible with id ${id}`)
        }
    }
