  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="content-block">
          <div
            className={`contact-icon-block ${
              isHorizontal ? "horizontal" : null
            }`}
          >
            <ContactIcon
              link="mailto:dylanvu9@gmail.com"
              icon={faEnvelope}
              id="email"
            />
            <ContactIcon
              link="https://github.com/dylanvu"
              icon={faGithub}
              id="github"
            />
            <ContactIcon
              link="https://www.linkedin.com/in/dylanvu9/"
              icon={faLinkedinIn}
              id="linkedin"
            />
            <ContactIcon
              link="https://medium.com/@mentor-mementos"
              icon={faMediumM}
              id="medium"
            />
          </div>
